...
int main(void)
{
 ...
 // MX_ETH_Init();
  ...
  lv_obj_set_pos(btn, 240, 100);                            /*Set its position*/
  lv_obj_set_size(btn, 100, 20);                          /*Set its size*/
 // lv_obj_set_event_cb(btn, btn_event_cb);                 /*Assign a callback to the button*/

  lv_obj_t * label = lv_label_create(btn, NULL);          /*Add a label to the button*/
  lv_label_set_text(label, "Speed up");                     /*Set the labels text*/

  lv_obj_t * btn1 = lv_btn_create(lv_scr_act(), NULL);     /*Add a button the current screen*/
  lv_obj_set_pos(btn1, 240, 200);                            /*Set its position*/
  lv_obj_set_size(btn1, 100, 20);                          /*Set its size*/
 // lv_obj_set_event_cb(btn, btn_event_cb);                 /*Assign a callback to the button*/

  lv_obj_t * label1 = lv_label_create(btn1, NULL);          /*Add a label to the button*/
  lv_label_set_text(label1, "Slowdown");                     /*Set the labels text*/

  lv_obj_t * btn2 = lv_btn_create(lv_scr_act(), NULL);     /*Add a button the current screen*/
  lv_obj_set_pos(btn2, 0, 0);                            /*Set its position*/
